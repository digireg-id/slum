                    ...
                    <!-- <div class="footer bg-white py-4 d-flex flex-lg-column " id="kt_footer">
                        <div class=" container  d-flex flex-column flex-md-row align-items-center justify-content-between">
                            ...
                            <div class="nav nav-dark order-1 order-md-2">
                                <span style="padding-top:5px;padding-right:10px">Supported By</span> <a href="https://www.digireg.id/" target="_blank"><img src="<?php echo base_url() ?>assets/media/logos/logo-letter-8.png" width="30px" height="20px" /></a>
                            </div>
                        </div>
                    </div> -->
                </div>
